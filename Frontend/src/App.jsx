...
const SELECT_FIELDS = [
  { key: "sex",            label: "Sex",                        options: [{ value: "",  label: "Select…" }, { value: "M", label: "Male" }, { value: "F", label: "Female" }] },
  { key: "chestPainType",  label: "Chest Pain Type",            options: [{ value: "", label: "Select…" }, { value: "ASY", label: "Asymptomatic (ASY)" }, { value: "ATA", label: "Atypical Angina (ATA)" }, { value: "NAP", label: "Non-Anginal Pain (NAP)" }, { value: "TA", label: "Typical Angina (TA)" }] },
  { key: "restingECG",     label: "Resting ECG",                options: [{ value: "", label: "Select…" }, { value: "Normal", label: "Normal" }, { value: "ST", label: "ST-T Abnormality" }, { value: "LVH", label: "Left Ventricular Hypertrophy" }] },
  { key: "fastingBS",      label: "Fasting Blood Sugar > 120",  options: [{ value: "", label: "Select…" }, { value: "0", label: "No (≤ 120 mg/dL)" }, { value: "1", label: "Yes (> 120 mg/dL)" }] },
  { key: "exerciseAngina", label: "Exercise-Induced Angina",    options: [{ value: "", label: "Select…" }, { value: "N", label: "No" }, { value: "Y", label: "Yes" }] },
  { key: "stSlope",        label: "ST Slope",                   options: [{ value: "", label: "Select…" }, { value: "Up", label: "Upsloping" }, { value: "Flat", label: "Flat" }, { value: "Down", label: "Downsloping" }] },
];

const EMPTY = {
  age: "", restingBP: "", cholesterol: "", maxHR: "", oldpeak: "",
  sex: "", chestPainType: "", restingECG: "", fastingBS: "", exerciseAngina: "", stSlope: "",
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
      ...
      <header className="bg-white border-b border-blue-100 shadow-sm">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-blue-900">Heart Disease Risk Prediction System</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-blue-100 p-6">
            ...
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Vital Measurements</h3>
            ...
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Clinical Indicators</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            {result && !result.error && (
              <div className={`bg-white rounded-2xl border-2 shadow-sm p-6 text-center ${isHigh ? "border-red-300" : "border-green-300"}`}>
                ...
                <button onClick={handleReset} className="text-sm text-blue-500 hover:text-blue-700 underline underline-offset-2 transition">
                  ↩ New Assessment
                </button>
              </div>
            )}
            ...
            {result?.error && (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-5 text-center">
                <p className="text-red-600 font-medium text-sm mb-3">{result.error}</p>
                <button onClick={handleReset} className="text-sm text-red-400 underline">Try again</button>
              </div>
            )}
      ...
      <footer className="text-center py-6 text-xs text-gray-400 border-t border-blue-100 mt-10">
        CardioAI © 2026 · React + Vite + Flask + Python
      </footer>
